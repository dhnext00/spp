    ...
    class Kelas {
        ...
        public function tampilKelas(){            
            ...
            while ($result = mysqli_fetch_array($this->kq)) {
                ...
                echo "<td>";
                ?>
                    <a href="../dashboard?url=editkelas&id_kelas=<?= $this->id_kelas ?>"><i class="fa-solid fa-pen-to-square w3-large"></i></a> | <a href="../proses/proses_hapus_siswa.php?id_kelas=<?= $this->id_kelas ?>"><i class="fa fa-trash w3-large"></i></a>
                <?php
                echo "</td>";
                echo "</tr>";
            }
